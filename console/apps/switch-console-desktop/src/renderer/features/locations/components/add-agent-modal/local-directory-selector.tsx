...
export function LocalDirectorySelector({
  ...
  return (
    ...
    <div className="flex h-9 w-full items-center gap-2 rounded-md border border-border pr-1.5 pl-2">
      ...
      <Button type="button" variant="outline" size="xs" onClick={handleOpenFileDialog}>
        Choose…
      </Button>
    </div>
  );
