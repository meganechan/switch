...
// Shell-availability detection has no RPC surface in switchdash — every session
// runs in the project dir with the system shell. Return the empty default so the
